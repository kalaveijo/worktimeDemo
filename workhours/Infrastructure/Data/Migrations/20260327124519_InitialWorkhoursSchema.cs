...
namespace workhours.Infrastructure.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialWorkhoursSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    WorkweekId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimeEntries_Workweeks_WorkweekId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_UserId_WorkweekId_EntryDate_ProjectName",
                table: "TimeEntries",
                columns: new[] { "UserId", "WorkweekId", "EntryDate", "ProjectName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_WorkweekId",
                table: "TimeEntries",
                column: "WorkweekId");
